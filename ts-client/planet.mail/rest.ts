 ...
 */
export type MailParams = object;

export interface MailQueryAllMessageResponse {
  Message?: MailMessage[];
...
/**
 * @title planet/mail/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryMessageAll
   * @summary Queries a list of Message items.
   * @request GET:/planet/mail/message
   */
  queryMessageAll = (
    query?: {
    ...
    this.request<MailQueryAllMessageResponse, RpcStatus>({
      path: `/planet/mail/message`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryMessage
   * @summary Queries a Message by id.
   * @request GET:/planet/mail/message/{id}
   */
  queryMessage = (id: string, params: RequestParams = {}) =>
    this.request<MailQueryGetMessageResponse, RpcStatus>({
      path: `/planet/mail/message/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/planet/mail/params
   */
